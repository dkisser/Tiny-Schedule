...
const api: RendererApi = {
  ...
  followUpUpsert: (req) => ipcRenderer.invoke(IpcInvokeContract.followUpUpsert.ch, req),
  followUpDelete: (req) => ipcRenderer.invoke(IpcInvokeContract.followUpDelete.ch, req),
  ideaUpsert: (req) => ipcRenderer.invoke(IpcInvokeContract.ideaUpsert.ch, req),
  ideaDelete: (req) => ipcRenderer.invoke(IpcInvokeContract.ideaDelete.ch, req),
